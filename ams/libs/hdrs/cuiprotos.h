...
long CUI_GetHeaders(char    *DirName, char    *date64, char    *headbuf, int  limit , long  startbyte, long  *nbytes, long  *status, int  RegisterCuids);
...
int CUI_RenameDir(char  *old , char  *new_c);
