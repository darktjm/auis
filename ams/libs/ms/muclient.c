...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/ams/libs/ms/RCS/muclient.c,v 1.11 1993/08/13 17:25:09 rr2b Stab74 $";
#endif
    ...
    int num;
{
    ...
    SIGNAL_RETURN_TYPE (*tmpfunc)(int sig);
#else
    SIGNAL_RETURN_TYPE (*tmpfunc)();
#endif    
    struct timeval to;
