...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/ams/libs/ms/RCS/clonemsg.c,v 2.13 1995/06/25 22:15:02 rr2b Stab74 $";
#endif
...
long            timetoset;
{
    ...
    if (timetoset) {
	UTIME_TYPE tvp;
	UTIME_SET(tvp, timetoset, timetoset);
        if (UTIME(ToName, &tvp)) {
