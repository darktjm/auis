...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/ams/libs/ms/RCS/msprint.c,v 2.33 1993/10/06 18:32:15 rr2b Stab74 $";
#endif
...
Boolean MustPrint;
{
	...
	if (! osi_vfork()) {
	    /* I am a child */
	    for (fd = FDTABLESIZE(); fd > 2; --fd) (void) close(fd);
