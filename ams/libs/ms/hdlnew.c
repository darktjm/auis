...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/ams/libs/ms/RCS/hdlnew.c,v 2.61 1996/09/03 18:58:15 robr Exp $";
#endif
...
EliSexp_t      *resbuf;
{
    ...
    if (lseek(Msg->OpenFD, Msg->BodyOffsetInFD + start, SEEK_SET) < 0) {
