...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/ams/libs/ms/RCS/mswp.c,v 2.60 1994/01/16 01:19:14 rr2b Stab74 $";
#endif
...
static int RefreshAliasFile()
{
    ...
    if (NeedToRead) {
	fd = open(AliasFileName, O_RDONLY, 0);
	if (fd<0) {
