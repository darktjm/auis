...
PUBLIC int SGML_abort  (HTStream * context, HTError e)
{
    int cnt;
...
PUBLIC void SGML_string (HTStream * context, CONST char* str)
{
    CONST char *p;
    for(p=str; *p; p++)
...
PUBLIC void SGML_write (HTStream * context, CONST char* str, int l)
{
    CONST char *p;
    CONST char *e = str+l;
    for(p=str; p<e; p++)
