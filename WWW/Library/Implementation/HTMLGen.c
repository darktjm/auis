...
PRIVATE void HTMLGen_flush (HTStructured * me)
{
...
PRIVATE void allow_break (HTStructured * me, int new_cleanness,
		BOOL dlbc)
{
...
PRIVATE void HTMLGen_output_character (HTStructured * me, char c)
{
...
**	---------------
*/
PRIVATE void HTMLGen_output_string (HTStructured * me, CONST char* s)
{
...
PRIVATE void HTMLGen_put_string (HTStructured * me, CONST char* s)
{
    while (*s) HTMLGen_put_character(me, *s++);
}

PRIVATE void HTMLGen_write (HTStructured * me, CONST char* s, int l)
{
...
*/
PRIVATE void HTMLGen_end_element (HTStructured * me,
				      int  element_number)
{
    if (element_number == HTML_PRE) {
        HTMLGen_output_character(me, '\n');
...
PRIVATE int HTMLGen_abort (HTStructured * me, HTError e)
{
    HTMLGen_free(me);
    return EOF;
}
...
PRIVATE int PlainToHTML_abort (HTStructured * me, HTError e)
{
    PlainToHTML_free(me);
    return EOF;
}
...
PUBLIC HTStream* HTPlainTo7BitHTML (
	HTRequest *		request,
	void *			param,
	HTFormat		input_format,
	HTFormat		output_format,
