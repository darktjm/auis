...
*//*
   ...
   reserved by them. Therefore the caller never has to (and never should) free() any
   ...
   until the next call.  This also makes it easy to plug the AA package in: you don't have
   to ponder whether to free() something here or is it done somewhere else (because it is
   always done somewhere else).
   ...
   This module is implemented by HTAAUtil.c, and it is a part of the Library of Common
   Code.
