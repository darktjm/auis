static char *contimer_rcsid = "$Header: /afs/cs.cmu.edu/project/atk-src-C++/contrib/atkbook/con/RCS/contimer.c,v 1.1 1992/10/06 22:08:31 susan Stab74 $";
...
struct contimer *self;
{
    ...
    contimer_NotifyObservers(self, observable_OBJECTDESTROYED);
}
