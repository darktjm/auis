...
extern NO_DLL_EXPORT zip_type_figure zipedit_Next_Selected_Figure( class zipedit	      *self, zip_type_pane	       pane, zip_type_figure	       figure );
...
extern NO_DLL_EXPORT void zipedit_Cancel_Enclosure( class zipedit	      *self, zip_type_pane	       pane );
...
extern NO_DLL_EXPORT void zipedit_Enclose_Figure( class zipedit	      *self, zip_type_figure	       figure, zip_type_pane	       pane );
...
extern NO_DLL_EXPORT void Show_Enclosure( class zipedit	      *self, zip_type_pane	       pane );
