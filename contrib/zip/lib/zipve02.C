...
extern NO_DLL_EXPORT void zipedit_Expose_Font_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT long zipedit_Hide_Font_Palette( class zipedit		  *self, zip_type_pane		   pane );
...
extern NO_DLL_EXPORT void zipedit_Expose_Shade_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT void zipedit_Hide_Shade_Palette( class zipedit		  *self, zip_type_pane		   pane );
...
extern NO_DLL_EXPORT void zipedit_Expose_Figure_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT void zipedit_Hide_Figure_Palette( class zipedit		  *self, zip_type_pane		   pane );
...
extern NO_DLL_EXPORT void zipedit_Expose_TL_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT void zipedit_Hide_TL_Palette( class zipedit		  *self, zip_type_pane		   pane );
static int Create_TR_Palette( class zipedit		  *self, zip_type_pane		   containing_pane, zip_type_pane		   pane, zip_type_pane		  *palette );
extern NO_DLL_EXPORT void zipedit_Expose_TR_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT void zipedit_Hide_TR_Palette( class zipedit		  *self, zip_type_pane		   pane );
static int Create_BL_Palette( class zipedit		  *self, zip_type_pane			   containing_pane, zip_type_pane			   pane, zip_type_pane			  *palette );
extern NO_DLL_EXPORT void zipedit_Expose_BL_Palette( class zipedit		  *self, zip_type_pane		   pane );
extern NO_DLL_EXPORT void zipedit_Hide_BL_Palette( class zipedit		  *self, zip_type_pane		   pane );
