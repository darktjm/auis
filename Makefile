...
DIRS = $(DESTDIR)  	$(DESTDIR)/bin 	$(DESTDIR)/config 	$(DESTDIR)/etc 	$(DESTDIR)/include 	$(DESTDIR)/lib 	$(DESTDIR)/lib/prs 	$(DESTDIR)/doc 	$(DESTDIR)/doc/ADMINISTRATOR 	$(DESTDIR)/doc/DEVELOPER 	$(DESTDIR)/doc/PROGRAMMER 	$(DESTDIR)/help
...
dependAll::
	...
	res=0; 	for i in $(SUBDIRS) $(EXTRASUBDIRS); do \
		...
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) dependAll ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
...
Doc::
	...
	res=0; 	for i in $(SUBDIRS); do \
		...
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) Doc ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
...
Aliases::
	...
	res=0; 	for i in $(SUBDIRS); do \
		...
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) Aliases ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
...
dependInstall::
	...
	res=0; 	for i in $(SUBDIRS); do \
	    (cd $$i; echo "building (dependInstall)" "(`pwd`)"; \
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) dependInstall ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
...
World::
	...
	res=0; 	for i in $(SUBDIRS); do \
		...
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) World ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
...
Tidy::
	...
	res=0; 	for i in $(SUBDIRS) $(EXTRASUBDIRS); do \
		...
		$(MAKE) $(MFLAGS) DESTDIR=$(DESTDIR) Tidy ); \
		res=$$((res>$$??res:$$?)); done; exit $$res)
