...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/adew/RCS/cel.C,v 1.7 1995/02/28 21:37:18 rr2b Stab74 $";
#endif
...
short cel::Get(class atom  *property, class atom  **type, long  *rock)
{
