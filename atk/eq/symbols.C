...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/eq/RCS/symbols.C,v 1.6 1996/10/14 17:48:21 robr Exp $";
#endif
...
*/
    ...
    "<",	SIMPLE, what SYM,	REL,	"<",
    Y_BINOP,	NIL,
    "<=",	SIMPLE, what SYM,	REL,	"l",
    Y_BINOP,	"less or equal",
    "=",	SIMPLE,	what SYM,	REL,	"=",	Y_EQ,		NIL,
    ">=",	SIMPLE, what SYM,	REL,	"g",
    Y_BINOP,	"greater or equal",
    ">",	SIMPLE, what SYM,	REL,	">",
    Y_BINOP,	NIL,

    "down",	SIMPLE, what SYM,	BIN,	"\\",
    Y_BINOP,	"downward arrow",
    "->",	SIMPLE, what SYM,	BIN,	"]",
    Y_GOESTO,	"right arrow",
    "up",	SIMPLE, what SYM,	BIN,	"^",
    Y_BINOP,	"upward arrow",
    "<-",	SIMPLE, what SYM,	BIN,	"_",
    Y_BINOP,	"left arrow",
...
*/
    ...
    "vbar",	SIMPLE, what SYMBOL,	OP,	"|",	Y_OP,	"vertical bar",
    "similar",	SIMPLE, what SYMBOL,	OP,	"~",	Y_OP,	"tilde",
