...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/eq/RCS/eqview.C,v 1.9 1995/11/07 20:17:10 robr Stab74 $";
#endif
...
/* From old eqview.h.  These need cleanup (probably not all used here, and the rest
