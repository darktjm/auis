...
attr:[FontFace Bold Int Set]}
\define{address
menu:[Region~4,Address~22]
attr:[LeftMargin ConstantMargin Inch 229376]
attr:[Flags NoFill Int Set]
attr:[Flags KeepPriorNL Int Set]
attr:[Flags KeepNextNL Int Set]}
\define{leftindent
...
\leftindent{Sincerely,



Joe Hacker.} \
\enddata{text,537656028}
