...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/raster/lib/RCS/xbm.C,v 1.4 1994/11/30 20:42:06 rr2b Stab74 $";
#endif
...
long xbm::ReadImage(FILE  *file		, class pixelimage  *pix	)
...
/* get width (in pixels) and height fields from top of bitmap file */
   ...
   /* determine width in bytes, and initialize pixelimage */
    bytewidth = (width + 7) / 8;
    (pix)->Resize( bytewidth * 8, height);
    location = (pix)->GetBitsPtr();
