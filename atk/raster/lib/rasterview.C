...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/raster/lib/RCS/rasterview.C,v 1.6 1995/07/18 04:33:31 rr2b Stab74 $";
#endif
...
/* end of paul's attempt to add X Bitmap I/O : */
  ...
  /* add old names to proctable */
    ...
    proc = DEFINEPROC("raster-copy-subraster", CopyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-replace-subraster", ReplaceCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-replace-subraster", ReplaceCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-scale-replace", ScaleReplaceCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-negative", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-white", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-black", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-gray", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-mirror-left-right", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-mirror-up-down", ModifyCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-rotate", rasterview_RotateCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-scale", ScaleCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-shrink-image", ShrinkCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-center-image", rasterview_CenterCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-upperleft-image", UpperLeftCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-zoom-in", rasterview_ZoomInCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-zoom-out", rasterview_ZoomOutCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-zoom-out-to-normal-size", NormalSizeCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-select-entire", SelectAllCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-region-select", rasterview_RegionSelectCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-touchup", TouchUpCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-pan", PanCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-move-display-box", rasterview_MoveDisplayBoxCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-hide-display-box", HideDisplayBoxCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-set-print-scaling", SetPrintSizeCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-extend-to-mat", ExtendToMatCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-crop", CropCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-uncrop", UncropCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-toggle-debug", ToggleDebug,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-file", ReadFileCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-xwdfile", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-file", ReadFileCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-macpaint", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-write-macpaint", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-write-postscript", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-rasterfile", ReadFileCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-xwdfile", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-write-xwdfile", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-read-xbmfile", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-write-xbmfile", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
#ifdef X11_ENV
    proc = DEFINEPROC("raster-make-xwd", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
    proc = DEFINEPROC("raster-make-asnap", RasterIOCommand,
		&rasterview_ATKregistry_ , 0, "Obsolete");
#endif
