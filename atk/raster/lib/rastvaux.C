...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/raster/lib/RCS/rastvaux.C,v 1.8 1996/10/18 18:53:44 wjh Exp $";
#endif
...
void rasterview::PrintPSRect(FILE *outfile, long logwidth, long logheight, struct rectangle *visrect)
{
    ...
    fprintf(outfile, "/rasterStr %d string store\n", rowbytes);
...
void rasterview_ZoomToVisualBounds(class rasterview  *self, long  x , long  y)
{
    ...
    DEBUG(("Enter rasterview_ZoomToVisualBounds: (%d, %d)\n", x, y));
