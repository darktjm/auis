...
extern NO_DLL_EXPORT void spread_update_FullUpdate(class spread  * V, enum view_UpdateType  how, struct rectangle  *updateClipRect);
extern NO_DLL_EXPORT void spread_PartialUpdate(class spread  * V, enum view_UpdateType  how, struct rectangle  *updateClipRect);
...
extern NO_DLL_EXPORT class view * MouseHit (class spread  * V, enum view_MouseAction  action, long  x , long  y, long  numberOfClicks		/* how should i use this?? */);
