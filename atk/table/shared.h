...
extern void  eval (register class table  * T, extended_double  *result, int      r , int      c, const char    *input);
...
extern void k_TellUser (register class spread  * V, const char    *s);
extern boolean k_AskUser (register class spread  * V, const char  prompt[], const char  def[], char  buff[], int  n);
extern boolean k_AreYouSure (register class spread  * V, const char  *why);
