...
extern int tpush(struct rofftext  *self,Trickle  t,char  *filename,FILE  *f,char  *s,boolean  push,int  argc,char  *argv[]);
extern int putregister(struct rofftext  *self,char  *name,int  value,enum RegFmt  fmt,int  inc,boolean  relative);
