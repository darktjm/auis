...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/examples/ex18/RCS/hwview.C,v 1.5 1996/12/19 20:24:14 fred Exp $";
#endif
...
class view *helloworldview::Hit(enum view_MouseAction  action,long  x,long  y,long  numberOfClicks)
{
	...
	return (this->applayer)->Hit(action,x-(this->x-this->frameX),
		y-(this->y-this->frameY),numberOfClicks);
