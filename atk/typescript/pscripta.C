...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/typescript/RCS/pscripta.C,v 1.6 1994/11/30 20:42:06 rr2b Stab74 $";
#endif
...
boolean pipescriptapp::ParseArgs(int  argc,char  **argv)
{
