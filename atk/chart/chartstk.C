...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/chart/RCS/chartstk.C,v 1.4 1995/11/07 20:17:10 robr Stab74 $";
#endif
...

class view *
chartstk::HitChart( register enum view_MouseAction       action, register long			       x , register long			       y , register long			       clicks )
        {
