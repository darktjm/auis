...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/console/stats/rt_aix221/RCS/getstats.c,v 1.7 1994/03/21 16:59:25 rr2b Stab74 $";
#endif
...
long wait_time_ticks;
     ...
     */
    (void) memmove(&last_sainfo, &this_sainfo, sizeof(this_sainfo));
}
