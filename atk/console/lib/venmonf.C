...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/atk/console/lib/RCS/venmonf.C,v 1.4 1993/06/13 17:37:39 rr2b Stab74 $";
#endif
...
void CheckTheMariner(char  *buf, class consoleClass  *self);
...
void CheckMariner(FILE  *ActiveVenus, char  *rock)
{
    class consoleClass *self = (class consoleClass *) rock;
#ifdef AFS_ENV
