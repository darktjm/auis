...
extern void dogtags_substitute(class text *self);
extern void dogtags_substituteregion(class text *self, long *posa, long *lena /* *posa and *lena passed by reference; *lena will probably be changing! */);
