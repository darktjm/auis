...
#define	OPSYSNAME	"sun4_5x" /* the full name of this operating system */
#define	sys_sun4_5x	1	/* sys_<system-type-name> should be defined to 1 */
#define	SYS_NAME	"sun4_5x" /* the short name of this operating system, should be the same as the system-type-name */
...
#define NEED_SCANDIR 1
#define NEED_AFSINATKOS 1
#define NEED_BSDMEMSTRFUNCS 1
#define NEED_AFSSTRFUNCS 1
