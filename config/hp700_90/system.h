...
#define	OPSYSNAME	"HPUX_700" /* the full name of this operating system */
#define	sys_hpux_900	1	/* sys_<system-type-name> should be defined to 1 */
#define	SYS_NAME	"hp700" /* the short name of this operating system, should be the same as the system-type-name */
...
#undef HAVE_DYNAMIC_INTERLINKING
#undef ATKLIBEXT
#undef ATKDYNEXT
#undef ATKDYNPREFIX
#define ATKLIBEXT "a"
