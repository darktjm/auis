...
#define	OPSYSNAME	"ix86_NetBSD" /* the full name of this operating system */
#define	sys_ix86_NetBSD	1	/* sys_<system-type-name> should be defined to 1 */
#define	SYS_NAME	"ix86_NetBSD" /* the short name of this operating system, should be the same as the system-type-name */

#ifdef In_Imake
#undef FAILEXIT
#define FAILEXIT test $$? -eq 0 || exit 1

#undef DynamicObjectObjs
#define DynamicObjectObjs(x) x $(DYNMAIN).o $(BASEDIR)/lib/dynlink/init.o
...
#undef ATKDYNEXT
#undef ATKDYNPREFIX
#define ATKLIBEXT "so.1.0"
#define ATKDYNEXT "so.1.0"
