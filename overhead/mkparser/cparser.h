...
typedef void (*parser_killfptr)(struct parser *self, void *vsp);
typedef void (*parser_errfptr)(struct parser *p, int severity, const char *sevname, const char *msg);
typedef int (*parser_semfptr)(int i, void *pyyval, void *yyvsp, struct parser *parser);
...
extern void parser_Error(struct parser *self, int severity, const char *msg);
		/* call this to report an error */
		 
extern	void parser_ErrorGuts(struct parser *self, int severity, const char *severityname, const char *msg);
