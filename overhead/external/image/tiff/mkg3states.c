...
short	find_horiz_mode_prefix(long, unsigned char);
...
static void
DECLARE3(write_null_mode_table, FILE*, fd, NullModeTable, table, const char*, name)
{
    int i, j;
    const char* outersep;
    const char* sep;
...
static void
DECLARE3(write_horiz_mode_table, FILE*, fd, HorizModeTable, table, const char*, name)
{
    int i, j;
    const char* outersep;
    const char* sep;
...
static void
write_define(FILE *fd, const char *name, int value, const char *comment)
{
...
static void
extern_table(FILE *fd, const char *name)
{
...
short
DECLARE2(find_horiz_mode_prefix, long, prefix, unsigned char, color)
{
    short j1;
