...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/overhead/mail/lib/RCS/stats.c,v 2.23 1994/06/09 18:17:42 rr2b Stab74 $";
#endif
...
static int OpenSocket()
{
    ...
    memset(&LogAddress, 0, sizeof LogAddress);
