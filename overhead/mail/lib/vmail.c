...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/overhead/mail/lib/RCS/vmail.c,v 2.26 1994/06/09 18:17:42 rr2b Stab74 $";
#endif
...
#endif /* LogsYes */
    fd = open(name, O_RDONLY, 0);	/* Get a file descriptor for IsOnVice() */
    statres = -1;
    if (fd >= 0) {
