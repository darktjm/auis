...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/overhead/mail/lib/RCS/ckamsdel.c,v 2.26 1994/06/09 18:17:42 rr2b Stab74 $";
#endif
...
{/* Get, or allocate, a struct AMSConfig record corresponding to the given domain. */
	...
	if (acf != NULL) {
	    memset(acf, 0, sizeof(struct AMSConfig));
