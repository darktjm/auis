...
#ifndef NORCSID
#define NORCSID
static UNUSED const char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-src-C++/overhead/mail/lib/RCS/locname.c,v 2.20 1994/06/09 18:17:42 rr2b Stab74 $";
#endif
...
#define NumSpecials (sizeof(Specials) / sizeof(Specials[0]))
	...
	*outPrime = *outSecond = NULL;
	...
	if (LastLocal != 0 && strchr(Addr->LocalPart, '!') != NULL) {
