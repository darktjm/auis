...
*/
extern char *bt_ErrorString(bt_ErrorCode  codevalue);
...
extern bt_ErrorCode bt_Create(char  *path, int  MaxFileSize , int  LockStyle, int  *Dum);
...
*/
extern bt_ErrorCode bt_Open(struct BTree  **btptr, char  *path , char  *mode);
/* Close a b-tree collection.
Declaration:
	extern bt_ErrorCode bt_Close(btptr);
	struct BTree *bt;		pointer to b-tree to close
*/
extern bt_ErrorCode bt_Close(struct BTree  *btp);
...
extern bt_ErrorCode bt_GetFixedHead(struct BTree  *bt, struct BTHead  *hdrloc, int  siz);
...
*/
extern bt_ErrorCode bt_NewCursor(struct BTree  *btp, struct btCursor  **cursptr);
/* Remove a cursor into an open b-tree.
Declaration:
	extern bt_ErrorCode bt_FreeCursor(curs);
	struct btCursor *curs;
*/
extern bt_ErrorCode bt_FreeCursor(struct btCursor  *curs);
...
extern enum bt_CursorState bt_GetCursorState(struct btCursor  *curs);
...
*/
extern bt_ErrorCode bt_CopyCursor(struct btCursor  **cursptr , struct btCursor  *curs);
...
Declarations:
	...
	struct btCursor *curs;
*/
extern bt_ErrorCode bt_CursorToStart(struct btCursor  *curs);
extern bt_ErrorCode bt_CursorToEnd(struct btCursor  *curs);
...
Declaration:
	...
	char *key;
*/
extern bt_ErrorCode bt_Search(struct btCursor  *curs, unsigned char *key);
...
Declaration:
	...
	char **keyLoc;
*/
extern bt_ErrorCode bt_GetCursorKey(struct btCursor  *curs, char  **keyLoc);
...
*/
extern bt_ErrorCode bt_GetCursorValueLen(struct btCursor  *curs, unsigned int *valueLen);
...
*/
extern bt_ErrorCode bt_GetCursorValueData(struct btCursor  *curs, char  *valueLoc, unsigned int valueLocSize , unsigned int *returnedLen);
...
*/
extern bt_ErrorCode bt_GetCursorValue(struct btCursor  *curs, char  **valueLoc, unsigned int *returnedLen);
...
Declaration:
	...
	struct btCursor *curs;
*/
extern bt_ErrorCode bt_NextCursor(struct btCursor  *curs);
...
Declaration:
	...
	char **Filename;
*/
extern bt_ErrorCode bt_GetCursorAttributes(struct btCursor  *curs, unsigned long  *ID1 , unsigned long  *ID2 , struct stat  **StatPtr, char  **Filename, unsigned long  *Offset);
...
Declaration:
	...
	unsigned int valueLen;
*/
extern bt_ErrorCode bt_Insert(struct BTree  *bt, char  *key , char  *valueLoc, unsigned int valueLen);
...
Declaration:
	...
	unsigned int valueLen;
*/
extern bt_ErrorCode bt_Replace(struct BTree  *bt, char  *key , char  *valueLoc, unsigned int valueLen);
...
Declaration:
	...
	char *key;
*/
extern bt_ErrorCode bt_Delete(struct BTree  *bt, char  *key);
...
*/
extern bt_ErrorCode bt_CondReplace(struct BTree  *bt, char  *key , char  *oldValueLoc , unsigned int oldValueLen , char  *newValueLoc, unsigned int newValueLen);
...
*/
extern bt_ErrorCode bt_CondDelete(struct BTree  *bt, char  *key , char  *oldValueLoc, unsigned int oldValueLen);
