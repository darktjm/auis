...
*/
extern char *wp_ErrorString(wp_ErrorCode  codevalue);
...
extern wp_ErrorCode wp_Initialize();
extern wp_ErrorCode wp_Terminate();
extern wp_ErrorCode wp_InitializeCell(char  *cellname , struct wp_cd  **cdp);
extern wp_ErrorCode wp_InitializeDir(char  *dirname , struct wp_cd  **cdp);
extern wp_ErrorCode cwp_Terminate(struct wp_cd  *cd);
extern wp_ErrorCode cwp_ReInitialize(struct wp_cd  *cd);
extern int wp_RetryThis(wp_ErrorCode  cod);
...
Declarations:
	...
	int val;
*/
extern int wp_SetDebugging(int  level);
extern int wp_SetTiming(int  level);
...
Declaration:
	...
	char *FName;
*/
extern wp_FieldIndex wp_FieldNameToIndex(char  *FName);
...
*/
extern wp_ErrorCode wp_DeAllocate(char  **StrPtr);
...
*/
extern wp_ErrorCode wp_SetUp(char  *NameProbe  , int  SearchKind , wp_SearchToken  *STPointer);
...
extern wp_ErrorCode wp_Constrain(wp_SearchToken  *STPointer , wp_FieldIndex  FieldNum, char  *Content , enum wp_ConstraintKind  ConstraintKind);
...
*/
extern wp_ErrorCode wp_Search(wp_SearchToken  SrchToken , int  MaxResults, int  MaxQuality , int  *MatchQuality , wp_PrimeKeySetPtr  *PKPtr);
extern wp_ErrorCode cwp_Search(struct wp_cd  *cd, wp_SearchToken  SrchToken , int  MaxResults, int  MaxQuality , int  *MatchQuality , wp_PrimeKeySetPtr  *PKPtr);
...
*/
extern wp_ErrorCode wp_Lookup(wp_SearchToken  SrchToken , int  *MinMatchesFound, int  MaxQuality , int  *MatchQuality , wp_PrimeKey  *PKPtr);
extern wp_ErrorCode cwp_Lookup(struct wp_cd  *cd, wp_SearchToken  SrchToken , int  *MinMatchesFound, int  MaxQuality , int  *MatchQuality , wp_PrimeKey  *PKPtr);
...
*/
extern wp_ErrorCode wp_GetNIDOnly(int  NID , wp_PrimeKey  *PKPtr);
extern wp_ErrorCode wp_GetUIDOnly(char  *UID , wp_PrimeKey  *PKPtr);
extern wp_ErrorCode cwp_GetNIDOnly(struct wp_cd  *cd , int  NID , wp_PrimeKey  *PKPtr);
extern wp_ErrorCode cwp_GetUIDOnly(struct wp_cd  *cd , char  *UID , wp_PrimeKey  *PKPtr);
...
*/
extern wp_ErrorCode wp_Read(wp_PrimeKey  PKey , wp_FieldIndex  FieldIx , char  **FValPtr);
extern wp_ErrorCode cwp_Read(struct wp_cd  *cd , wp_PrimeKey  PKey , wp_FieldIndex  FieldIx , char  **FValPtr);
...
*/
extern wp_ErrorCode wp_AllFields(wp_FieldIndex  FieldIx , char  **FNamPtr);
...
*/
extern wp_ErrorCode wp_Generate(wp_PrimeKey  *PKPtr);
extern wp_ErrorCode cwp_Generate(struct wp_cd  *cd , wp_PrimeKey  *PKPtr);
