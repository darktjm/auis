...
extern int wpSortIxValue(char  *IxLoc , int  IxSize);
...
extern char *CanonSurn(char  *str);
extern char *CanonGiven(char  *str);
extern char *CanonNick(char  *str);
...
extern wp_ErrorCode w_BTreeErr(bt_ErrorCode  code);
